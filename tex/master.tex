...
\tiny Preuzeto sa \url{ https://tinyurl.com/y5g987j5 } 
\label{fig:batman}
\end{figure}
...
\begin{figure}
	...
	\tiny Preuzeto sa \url{ https://tinyurl.com/y6qbaxqm }
	\label{fig:horse}
\end{figure}
...
\begin{figure}[h!]
	...
	\tiny Preuzeto sa \url{ https://tinyurl.com/yxbqg5hq }
	\label{fig:counter}
\end{figure}
...
\begin{figure}[h!]
	...
	\tiny Preuzeto sa \url{ https://tinyurl.com/y2c6nw5l }
	\label{fig:txaa}
\end{figure}
...
\begin{figure}[h!]
	...
	\caption{Tuneliranje.}
	\tiny Preuzeto sa \url{ https://tinyurl.com/yxjz7vga }
	\label{fig:tunnel}
\end{figure}
...
\begin{figure}[h!]
	...
	\tiny Preuzeto sa \url{ https://tinyurl.com/yyjhzlyo }
	\label{fig:hitbox}
\end{figure}
...
\begin{figure}[h!]
	...
	\tiny Preuzeto sa \url{ https://tinyurl.com/y4ep88wa }
	\label{fig:oct}
\end{figure}
...
\begin{figure}[h!]
	...
	\tiny Preuzeto sa \url{ https://tinyurl.com/y3zetsmj }
	\label{fig:sap}
\end{figure}
...
\begin{figure}[h!]
	...
	\tiny Preuzeto sa \cite{glavnaKnjiga}
	\label{fig:cellsObj}
\end{figure}
...
Za preprocesiranje i prikaz podataka korišćen je programski jezik Python,
...
što se može videti na \ref{fig:drawVsNoDraw}, gde tek za vrednosti bliske 50 000 objekata relativan dt prelazi 2. 
...
Na osnovu grafika prikazanih prikazanih u ovoj glavi može se se može primetiti da za drugačije
