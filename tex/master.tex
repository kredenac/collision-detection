...
Celokupan zadatak detekcije kolizije se deli na dve faze: široku (eng. {\em broadphase}) i usku fazu (eng. {\em narrowphase}). 
...
se radi u uskoj fazi. Bounding volume hierarchies, AABB tree, OBB tree.
...
Još jedan primer u tri dimenzije: jedan AABB može da sadrži izduženu loptu, a drugi 
da sadrži objekat koji izgleda kao ram slike, kao što je na slici TODO. 
Tada se zaista njihove kutije seku, iako tela unutar njih nemaju presek.
