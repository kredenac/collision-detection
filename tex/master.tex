...
\begin{figure}[h!]
	\centerfloat
	\includegraphics[scale=0.3]{ssyank.png}
	\caption{todo.}
	\label{fig:ssyank}
\end{figure}
...
Grafici \label{fig:oktri1} i \label{fig:oktri2} se odnose na oktri sa duplikatima.
Oktri sa i bez duplikata su često sličnih performansi.
Međutim, postoje situacije kada to nije tako. 
Jedna od njih je kada se veliki broj objekata nalazi na istom mestu.
...
\begin{figure}[h!]
	...
	\caption{Relativan dt u zavisnosti od broja objekta kada se objekti sporo kreću - SAP.}
	\label{fig:sap_great}
\end{figure}
