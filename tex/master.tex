...
Na slici \ref{fig:compare_all} su uporedo prikazane performanse implementiranih algoritama.
...
\begin{figure}[h!]
	...
	\includegraphics[
		trim=0 0 0 19,clip,
		scale=1]{compare_all.pdf}
	\caption{Poređenje performansi kvadratnog algoritma, SAP algoritma, oktrija sa duplikatima i oktrija bez duplikata.}
